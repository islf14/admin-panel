            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Listar trámites</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Solicitudes de trámite entrantes</h4>
                            <p class="card-title-desc">Se puede responder o aceptar las solicitudes.
                            </p>
