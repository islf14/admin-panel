            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        {{-- <li class="mm-active"><a class="active" href="index.html">Default</a></li> --}}
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{ route('tramite.index') }}">Entrada</a></li>
                        <li><a href="#">Observados</a></li>
                        <li><a href="#">Corregidos</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#">Listar oficinas</a></li>
